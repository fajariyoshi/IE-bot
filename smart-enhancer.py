...
bot = Bot(token='6394932970:AAHWG2YYpZrVy3XMwLG_6AlRoiJkQk1jAjg')   # REPLACE YOUR TELEGRAM BOT TOKEN HERE
dp = Dispatcher(bot)

API_KEY = "vwYDa72zHVgoTpANuB1TfsAQuBq1H5LP2QB3w8RELyxgCfNw"   # REPLACE YOUR REMINI API KEY THAT HAS CREDITS
...
async def start_command(message: types.Message):
    ...
    dev_button = InlineKeyboardButton("Oleh", url="https://t.me/pesonagoodboy")
    update_button = InlineKeyboardButton("Update ✅", url="https://t.me/pesonagoodboy")
    keyboard.add(dev_button, update_button)

    # Send the welcome message with the inline keyboard
    await bot.send_message(
        message.chat.id,
        "<b>Selamat datang! Saya adalah BOT Penambah Cerdas. Tolong kirimkan saya foto untuk menyempurnakannya.</b>",
        parse_mode='html',
...
async def handle_invalid_message(message: types.Message):
    await bot.send_message(message.chat.id, "<b>Saya tidak diperbolehkan menerima pesan teks atau emoji apa pun.\n\nPlis kirim hanya poto.</b>", parse_mode='html')
